...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/p4_e1

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/p4_e1: ${OBJECTFILES}
...
${OBJECTDIR}/tree_aux.o: tree_aux.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tree_aux.o tree_aux.c
