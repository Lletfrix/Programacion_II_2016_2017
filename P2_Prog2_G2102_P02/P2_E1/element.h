...
/**------------------------------------------------------------------
Modifica los datos de un elemento. Crea una copia de los datos del elemento a introducir. Entrada: El elemento a modificar y el contenido a guardar en dicho
...
Salida: Devuelve el número de caracteres escritos. -1 si hay error en los argumentos de entrada.
------------------------------------------------------------------*/
